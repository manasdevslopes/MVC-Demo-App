...
class ProductLine
{
    ...
    class var numberOfProducts: Int {
        get{
            return (ProductLine.iDevices().products.count + ProductLine.iPod().products.count + ProductLine.mac().products.count + ProductLine.software().products.count + ProductLine.iCloudAndApplePay().products.count)
        }
    }
